...
- **Baseline** (22.09.2026, `qwen3.8-27b-dflash2` локально, cost $0.000):
  **6/6 + 6/6 = 100%** на повторном прогоне; разбег прогонов 93–100%
  (единичные промахи — вариативность модели, не систематика). Историческая
  динамика: 84% (первый baseline) → 93–100% после правок промпта observer'а
  (stable-user-facts + explicit-remember правила) и честной переработки кейса
  user-preferences (вся история в одном чанке 150 — без необозреваемого хвоста).
